...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteUserAsync: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteUserAsync(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteUserAsync(options);
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        deleteUserAsync(options?: any): AxiosPromise<void> {
            return localVarFp.deleteUserAsync(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 사용자의 현재 정보와, 소속되어 있는 채널 정보를 반환합니다.
...
export class UsersApi extends BaseAPI {
    ...
    public deleteUserAsync(options?: AxiosRequestConfig) {
        return UsersApiFp(this.configuration).deleteUserAsync(options).then((request) => request(this.axios, this.basePath));
    }
