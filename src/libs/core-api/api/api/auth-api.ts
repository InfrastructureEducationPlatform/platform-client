...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        loginAsync: async (LoginRequest?: LoginRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        refreshAsync: async (RefreshTokenRequest?: RefreshTokenRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async refreshAsync(RefreshTokenRequest?: RefreshTokenRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.refreshAsync(RefreshTokenRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        refreshAsync(RefreshTokenRequest?: RefreshTokenRequest, options?: any): AxiosPromise<TokenResponse> {
            return localVarFp.refreshAsync(RefreshTokenRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 서비스에 회원 가입합니다.
...
export class AuthApi extends BaseAPI {
     ...
     * @memberof AuthApi
     */
    public refreshAsync(RefreshTokenRequest?: RefreshTokenRequest, options?: AxiosRequestConfig) {
        return AuthApiFp(this.configuration).refreshAsync(RefreshTokenRequest, options).then((request) => request(this.axios, this.basePath));
    }
