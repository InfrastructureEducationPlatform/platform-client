...
import React, { ForwardRefRenderFunction, MutableRefObject, Ref, forwardRef, useEffect, useRef, useState } from 'react';
...
export function OnboardingTour() {
  ...
  const steps: TourProps['steps'] =[
    {
      title:'환영합니다.',
      description: '본 화면은 채널 홈화면입니다. 같은 채널의 구성원 간의 스케치를 공유할 수 있습니다.',
    },
    {
      title:'채널 네비게이션바',
      description: '채널 네비게이션바를 통해 본인이 속한 다른 채널 홈화면으로 이동할 수 있습니다.',
      target: () => refSelector.current!,
    },
    {
      title:'스케치 목록',
      description: '스케치 목록에서는 본 채널에서 작성한 스케치를 확인할 수 있습니다.',
      target: () => {
    ...
    },
    {
      ...
      description: '현재 표시된 스케치 생성 버튼을 누르면 새로운 스케치를 생성할 수 있습니다.',
