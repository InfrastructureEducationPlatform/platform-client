...
function InputBox(){
    ...
    return(
        ...
        <div style={{width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            {/* Outer Content Area */}
            <div style={{width: '720px', height: '610px', background: '#A87575', display: 'flex', alignItems: 'center', justifyContent: "center"}}>
                {/* Inner Content Area */}
                <div style={{background: 'white', width: '640px', height: '500px', display: 'flex', alignItems: 'center', justifyContent: "center", flexDirection: 'column'}}>
                    ...
                    <form onSubmit={onSubmit} style={{
                        ...
                        <label htmlFor="userEmailInput">사용자 이메일</label>
                            <input type="text" onChange={(event) => setUserEmail(event.target.value)} value={userEmail}/>
                        </div>
                        <button style={{width: '30%'}} type="submit">회원가입</button>
                    </form>
                </div>
            </div>
        </div>
